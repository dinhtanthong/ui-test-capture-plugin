			...
			$(appendList).append(
				...
				"<dd style=\"display:none;\">" +
					...
					"<div class=\"observacoes\">" +
						...
						"<div class=\"description-commands\"><span class=\"description-status\" id=\"description-status-"+obj.metodo.replace(/\./g,"")+"\"></span><input type=\"button\" value=\"Save\" onClick=\"javascript:ajaxUpdateQuarantineDescription('"+obj.metodo+"');\" /></div>" +
					"</div><br />"+
					
				"</div>"+
					"<div style='font-size:12px;margin-bottom:20px;'><strong>Build history:</strong> "+
						historicoStatus +		
					"</div>"+
					((obj.status != "sucesso") ? 
